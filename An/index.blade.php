...
@section('body')
    <main>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                    <img src="front/OnlineEdu/img/hero/heroman.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {{--  Teachers (AN)--}}
        <div class="team-area pt-160 pb-160 section-bg" data-background="front/OnlineEdu/img/gallery/section_bg02.png">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-70">
                            <a href="instructor" class="btn white-btn">View All Faculty</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle mb-35">
                                <span>More About Our Institution</span>
                                <h2>Want to know more</h2>
                            </div>
                            <p>Students like the interactive games to practice reading and writing. As a teacher, I love
                                the correlation to standards, and that I am
                                able to see the progress and struggles my students have in obtaining skills.</p>
                            <ul>
                                <li><span class="flaticon-business"></span> Creative ideas</li>
                                <li><span class="flaticon-communications-1"></span> Supportive teachers</li>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="front/OnlineEdu/img/gallery/about2.png" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="front/OnlineEdu/img/gallery/about1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($teachers as $teacher)
                                <div class="single-testimonial pt-65">
                                    ...
                                    <div class="testimonial-icon mb-45">
                                        <img src="front/OnlineEdu/img/gallery/{{ $teacher->avatar }}" class="ani-btn w-25" alt="">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="front/OnlineEdu/img/gallery/home-blog1.png" alt="">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="front/OnlineEdu/img/gallery/home-blog2.png" alt="">
