...
{{--                        </div>--}}
                        ...
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextField">
                                <input class="mdl-textfield__input" type="text" id="txtDepartment" name="specialty" >
                                <label class="mdl-textfield__label" for="txtDepartment">
                                    Department
                                </label>
                                <span class="text-danger">@error('specialty') {{ $message }} @enderror</span>
                            </div>
                        </div>
...
{{--                        </div>--}}
                        ...
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width is-upgraded" data-upgraded=",MaterialTextField">
                                <input class="mdl-textfield__input flatpickr-confirm" type="text" id="dateOfBirth" name="dob" >
                                <label class="mdl-textfield__label">
                                    Birth Date
                                </label>
